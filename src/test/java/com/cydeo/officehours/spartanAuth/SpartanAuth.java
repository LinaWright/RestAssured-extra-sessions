package com.cydeo.officehours.spartanAuth;
...
public class SpartanAuth extends SpartanSecureTestBase {
    ...
    void testAllUserGet(String role) {
        given().accept(ContentType.JSON)
    ...
    public void DELETESpartansCSVFile(String username, String password, int id, int statusCode){
        given().accept(ContentType.JSON)
                .pathParam("id",id)
                .auth().basic(username,password)
                .delete("/spartans/{id}").prettyPeek()
